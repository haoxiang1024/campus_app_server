...
) ENGINE = InnoDB AUTO_INCREMENT = 35 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '评论信息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '积分兑换订单表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 55 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '失物招领信息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `lostfound` VALUES (53, '123', '0e3b523e-8408-42a6-a4a4-aca18d075e46.jpg', '2026-04-09 15:06:38', '123', '中国四川省广安市广安区井河镇（皂角岩）', '18784212634', '待审核', 0, 2, 21, NULL, '失物', 106.629542, 30.736848);
INSERT INTO `lostfound` VALUES (54, '223', 'a45e4931-fbc8-46df-b7b4-2c0f62df6a1a.jpg', '2026-04-09 15:07:38', '223', '中国四川省广安市广安区井河镇（双胜电动三轮车）', '18784212634', '待审核', 0, 3, 21, NULL, '招领', 106.629542, 30.736848);
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '留言信息表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `shop_item` VALUES (1, '文具套装', NULL, '0dfa7974-366c-41a4-ab67-ea665253a871.jpg', 500, 20, 1);
INSERT INTO `shop_item` VALUES (2, '小词典', NULL, '03e4ca48-a041-47a4-98a3-97c294b01e55.jpg', 50, 10, 1);
INSERT INTO `shop_item` VALUES (3, '优惠券', NULL, 'af187150-4cff-4411-9c3e-a048d61c7380.jpg', 50, 100, 1);
INSERT INTO `shop_item` VALUES (4, '高等数学第7版上下册同济大学', NULL, '8acfd498-b16a-4f51-b143-64e4aa840156.jpg', 500, 10, 1);
INSERT INTO `shop_item` VALUES (5, '水杯', NULL, '36aab817-d58e-48dc-9565-c7d8c559f178.jpg', 1000, 20, 1);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', '18682675515', '3502777299@qq.com', '$2a$12$Ikp/n4voUd3RAiwF9YFZr.hHM3j60HYtE37TMqGIquuaqYCyTo3YG', '62acf3a1-81f7-4e43-bf8b-a6e18a6794be.jpg', '男', 500, '2026-04-03 15:49:11', 1, 0, 'j3iWf2UVvHvWe8Gagt9eVucOVPaubDvP@5zau.cn.rongnav.com;5zau.cn.rongcfg.com');
...
INSERT INTO `user` VALUES (21, '小果', '18784212633', '3502777299@qq.com', '$2a$12$P4pUCjD0JIokvcNOmX0P5.IPp64vi4PbXLpwIo/84Qz6gaZwvYPa2', '43959d47-e69f-484b-bb93-0793ce0c0845.jpg', '男', 0, '2026-04-09 15:05:03', 1, 0, 'RVMe+PfShcx506fu7H8tdLgYNHyLmtLX@5zau.cn.rongnav.com;5zau.cn.rongcfg.com');
